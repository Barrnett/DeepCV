...
def convert_annotation(year, image_id, list_file, classes, VOCdevkit_path):
...
def deal(classes_path, trainval_percent=0.9, train_percent=0.9):
    """
    :param classes_path: 必须要修改，用于生成2007_train.txt、2007_val.txt的目标信息
    ...
    if annotation_mode == 0 or annotation_mode == 2:
        ...
        for year, image_set in VOCdevkit_sets:
            ...
            for image_id in image_ids:
                ...
                convert_annotation(year, image_id, list_file, classes, VOCdevkit_path)
                list_file.write('\n')
            list_file.close()
